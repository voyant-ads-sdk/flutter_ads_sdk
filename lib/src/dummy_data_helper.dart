...
class FlutterAdsDummyDataHelper {
  ...
  static void fillDemoAds() {
    //miniNativeTestAds
    FlutterAds.instance.miniNativeTestAds.clear();
    FlutterAds.instance.miniNativeTestAds.add(
    ...
    //nativeTestAds
    FlutterAds.instance.nativeTestAds.clear();
    // FlutterAds.instance.nativeTestAds.add(
    //   NativeAdDataModel(
    //     adId: 'demo_native_1',
    //     logoModel: logoModel,
    ...
    FlutterAds.instance.nativeFullScreenTestAds.clear();
    // FlutterAds.instance.nativeFullScreenTestAds.add(
    ...
    //rewardingTestAds
    FlutterAds.instance.rewardingTestAds.clear();
    FlutterAds.instance.rewardingTestAds.add(
    ...
    FlutterAds.instance.videoEmbeddedTestAds.clear();
    FlutterAds.instance.videoEmbeddedTestAds.add(
