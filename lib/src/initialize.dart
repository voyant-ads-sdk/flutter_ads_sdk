...
///
/// Use [FlutterAds.instance] to access the singleton.
///
import 'dart:convert';
import 'dart:io';
import 'dart:math';
...
sealed class FlutterAdsWrapperBase {}
...
final class FlutterAds extends FlutterAdsWrapperBase {
  static final FlutterAds _singleton = FlutterAds._internal();
  factory FlutterAds() => _singleton;
  //
  ...
  /// Initializes the Flutter Ads SDK.
  ///
  ...
  _setDeviceId() async {
    ...
    appSettingsBox = await Hive.openBox<dynamic>("flutter_ads_sdk_settings");
